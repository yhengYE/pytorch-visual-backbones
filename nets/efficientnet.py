...
def EfficientNetModel(model_name='efficientnet-b0', pretrained=False, num_classes=1000, in_channels=3):

    if pretrained:
        model = EfficientNet.from_pretrained(model_name, in_channels=in_channels, num_classes=num_classes)
    else:
        model = EfficientNet.from_name(model_name, in_channels=in_channels, num_classes=num_classes)
