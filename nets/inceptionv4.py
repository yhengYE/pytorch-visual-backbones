...
class SingleTask(nn.Module):
    ...
    def Unfreeze_backbone(self):
        # Unfreeze all layers (both feature extraction and classifier parts)
...
def inceptionv4(num_classes=1000, pretrained=True, progress=True):
    ...
    if pretrained:
        ...
        state_dict = load_state_dict_from_url(settings['url'], model_dir='..\\model_data', progress=progress)
    ...
    # 获取 Sequential 中的最后一层 Linear 层
    in_features = model.fc[-1].in_features  # 获取最后一层 Linear 层的 in_features
